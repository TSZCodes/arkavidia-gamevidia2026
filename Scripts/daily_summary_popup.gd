...
@onready var wallet_label = $VBoxContainer/ScrollContainer/SummaryVBox/WalletLabel
@onready var assets_label = $VBoxContainer/ScrollContainer/SummaryVBox/AssetsLabel
@onready var total_label = $VBoxContainer/ScrollContainer/SummaryVBox/TotalLabel
@onready var changes_vbox = $VBoxContainer/ChangesScroll/ChangesVBox
@onready var debt_label = $VBoxContainer/ChangesScroll/ChangesVBox/DebtLabel
@onready var net_change_label = $VBoxContainer/NetChangeLabel
